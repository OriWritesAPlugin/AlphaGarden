...
import { refs, replace_color_palette_single_image, overall_palette, base_foliage_palette, preload_single_image, gen_named, decode_plant_data, gen_plant, preload_spritesheet, random_from_list } from "./gen_plant.js";
...
async function gen_randogarden(reuse_and_scramble_positions=false) {
    ...
    if(midground != undefined) { place_tileable(midground); }
...
function get_hex_from_overlay_name(color){
    ...
    if(Object.prototype.hasOwnProperty.call(available_overlay_colors, hex_code)){ hex_code = available_overlay_colors[hex_code]; }
    return hex_code;
}
...
export { resize_for_garden, scramble_randogarden, claim_garden, do_preload, get_canvas_for_named_component, get_canvas_for_plant, available_overlay_colors, available_tileables, available_backgrounds, do_preload_initial, available_ground_base };