...
function display_release_note(){
    ...
    if (localStorage.last_broadcast_number == undefined) { last_broadcast_number=0;}
    else {last_broadcast_number = JSON.parse(localStorage.last_broadcast_number);}
