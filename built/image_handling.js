...
async function resize_for_garden(name_of_image, sourceURL) {
    ...
    wildcard_ctx.drawImage(temp_img, 0, work_canvas_size - temp_img.naturalHeight * (work_canvas_size / max_side), temp_img.naturalWidth * (work_canvas_size / max_side), temp_img.naturalHeight * (work_canvas_size / max_side));
...
export { refs, replace_color_palette_single_image, preload_single_image, preload_spritesheet, replace_color_palette, applyOverlay, draw_outline_v2, tile_along_y, imageFromPopup, clearCanvas, drawSkyGradient, wildcard_canvases };
