                    ...
                    "Overgrown Root Tunnels": {
                        "SCENES": {
                            ...
                            "berry patch": {
                                ...
                                "choices": [{ "text": "Eat some now", "goto": "berry patch harvested" },
                                    { "text": "Harvest some for later", "goto": "berry patch harvested" },
                                    { "text": "Ignore them and continue walking", "goto": "$WANDERABLE" }],
                                "wanderable": true
                            },
                            "berry patch harvested": {
                                "text": ["$THEY grab$PLURAL some bright, juicy berries. Plenty remain dormant and ripening, ready for some other traveler."],
                                "backdrop": "$UNCHANGED",
                                "choices": [{ "text": "Eat and eat and eat", "goto": "berry patch fullharvest" },
                                    { "text": "Harvest every last one", "goto": "berry patch fullharvest" },
                            ...
                            "desert pillars": {
                                ...
                                "choices": [{ "text": "That's all for now", "goto": "entry cavern" }],
                            },
                        }
                    }
                }
...
ITEMS = { "sroot strange package": { "name": "strange package", "description": "A small but heavy package meant to be delivered somewhere in the root tunnels" },
